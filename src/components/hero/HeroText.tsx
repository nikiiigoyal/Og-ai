...
export default function HeroText() {
    return(
        <div className="flex flex-col gap-6 mx-auto p-8">
            ...
            <div className="lg:flex flex-start">
                ...
                <button className="px-6 py-3 mb-3 mr-5 bg-[#0000000d] border border-[#0003] text-black rounded-lg transition-all duration-300 font-semibold">Support ØG on X</button>
            </div>
        </div>
    )
}